...
public class BonusFuncionarios {
	...
	public static void main(String[] args) {
		...
		if (bateuAMeta) {
			System.out.println("Ganha um bônus de 100%! Ele será de: " + mediaSalarial);
		} else if (faturouPeloMenosOitentaPorCento) {
			Double oitentaPorCentoDaMediaSalarial = (mediaSalarial * 80) / 100; 

			System.out.println("Ganha um bônus de 80%! Ele será de: " + oitentaPorCentoDaMediaSalarial);
		} else {
			System.out.println("Esse ano não tem bônus!");
		}
